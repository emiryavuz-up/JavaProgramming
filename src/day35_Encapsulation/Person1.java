...
public Person1(String name, int age, char gender, String language){ // instances belong to the objects so they should be set like this to access them easily
...
public void printPlanetName(){ // if the method has static members, then it should be static // note: nested class can be static but only the inner one
