...
public class day10_TernaryPractice {
    ...
    public static void main(String[] args) {
        ...
        System.out.println( (n1 > n2 && n1 > n3)? n1 + " is bigger" :(n2 > n1 && n2 > n3)? n2 + " is bigger"
                :(n3 > n1 && n3 > n2)? n3 + " is bigger." : "Invalid Input");
    }
...
/*
Create a class called BiggerNum, write a program that checks for the biggest of 3 numbers.
